...
public class EjercicioMatrices {
    ...
    public static void pintarMovimientosCaballo(int i, int j, String tablero[][]) {
        ...
        if (tablero[i][j].equals("BL") || tablero[i][j].equals("WL")) {
             ...
             */
            if ((j - 2 >= 0 && i + 1 >= 7) && (tablero[i][j] == "B" || tablero[i][j] == "W")) {
                System.out.println("El caballo puede moverse a izquierda dos y arriba uno.");
            }
            if ((j - 2 >= 0 && i - 1 <= 0) && (tablero[i][j] == "B" || tablero[i][j] == "W")) {
            ...
            if ((j - 1 >= 0 && i + 2 >= 7) && (tablero[i][j] == "B" || tablero[i][j] == "W")) {
                System.out.println("El caballo puede moverse arriba dos y izquierda uno.");
            }
            if ((j - 1 >= 0 && i - 2 <= 0) && (tablero[i][j] == "B" || tablero[i][j] == "W")) {
    ...
    public static void main(String[] args) {
         ...
         */
         ...
         /*Ahora vamos a llamar a los procesos de las cordenadas y comprobacion del movimiento del caballo */
        System.out.println();
        System.out.println("Parte tres:");

        coordenadasAjedrez(0, 3);

        pintarMovimientosCaballo(7, 1, tableroAjederez);
